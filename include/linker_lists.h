...
#ifndef CONFIG_LINKER_LIST_ALIGN
#define CONFIG_LINKER_LIST_ALIGN CPU_ALIGNMENT
#endif
...
#define llsym(_type, _name, _list) \
		((_type *)&_rtems_list_2_##_list##_2_##_name)
...
#define ll_entry_declare(_type, _name, _list) \
	__ll_entry_declare(_type, _name, _list, rw)
#define __ll_entry_declare(_type, _name, _list, _attr)				\
	_type _rtems_list_2_##_list##_2_##_name __aligned(4)		\
		__attribute__((used))				\
		__section(".rtems"#_attr"set.rtems_list_2_"#_list"_2_"#_name)
/**
...
#define ll_entry_declare_list(_type, _name, _list) \
	__ll_entry_declare_list(_type, _name, _list, rw)
#define __ll_entry_declare_list(_type, _name, _list, _attr)			\
	_type _rtems_list_2_##_list##_2_##_name[] __aligned(4)		\
			__attribute__((used))				\
			__section(".rtems"#_attr"set.rtems_list_2_"#_list"_2_"#_name)
 ...
 */
#define ll_entry_start(_type, _list) __ll_entry_start(_type, _list, rw)
#define __ll_entry_start(_type, _list, _attr)					\
({									\
	static char start[0] __aligned(CONFIG_LINKER_LIST_ALIGN)	\
		__attribute__((used))					\
		__section(".rtems"#_attr"set.rtems_list_2_"#_list"_1");			\
	(_type *)&start;						\
})
/**
 ...
 */
#define ll_entry_end(_type, _list) __ll_entry_end(_type, _list, rw)
#define __ll_entry_end(_type, _list, _attr)					\
({									\
	static char end[0] __aligned(4) __attribute__((used))		\
		__section(".rtems"#_attr"set.rtems_list_2_"#_list"_3");			\
	(_type *)&end;							\
})
...
#define ll_entry_get(_type, _name, _list)				\
	({								\
		extern _type _rtems_list_2_##_list##_2_##_name;	\
		_type *_ll_result =					\
			&_rtems_list_2_##_list##_2_##_name;		\
		_ll_result;						\
	})
 ...
 */
#define ll_start(_type)	__ll_start(_type, rw)
#define __ll_start(_type, _attr)							\
({									\
	static char start[0] __aligned(4) __attribute__((used))	\
		__section(".rtems"#_attr"set.rtems_list_1");				\
	(_type *)&start;						\
})
 ...
 */
#define ll_end(_type) __ll_end(_type, rw)
#define __ll_end(_type, _attr)							\
({									\
	static char end[0] __aligned(4) __attribute__((used))		\
		__section(".rtems"#_attr"set.rtems_list_3");				\
	(_type *)&end;							\
})
