 ...
 * model code, since the pointer must be within the _dm_priv_base region.
 *
 * @dev		Device to check
...
#define DM_ROOT_NON_CONST		    (_dm_root)
#define DM_UCLASS_ROOT_NON_CONST	(_uclass_root)
#define DM_UCLASS_ROOT_S_NON_CONST	(_uclass_root_s)
...
extern struct udevice *_dm_root;
extern  struct list_head _uclass_root_s;
extern  struct list_head *_uclass_root;

#if CONFIG_IS_ENABLED(OF_PLATDATA_RT)
extern struct udevice_rt *_dm_udevice_rt;
extern void *_dm_priv_base;
#define gd_set_dm_udevice_rt(dyn)	_dm_udevice_rt = dyn
#define gd_dm_udevice_rt()		_dm_udevice_rt
#define gd_set_dm_priv_base(dyn)	_dm_priv_base = dyn
#define gd_dm_priv_base()		_dm_priv_base
#else
...
extern struct driver_rt *_dm_driver_rt;
#define gd_set_dm_driver_rt(dyn)	_dm_driver_rt = dyn
#define gd_dm_driver_rt()		_dm_driver_rt
#else
