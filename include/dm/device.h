...
#define DM_DRIVER(__name) U_BOOT_DRIVER(__name)
...
static inline void *dev_get_plat(const struct udevice *dev)
{
	return dev->plat_;
}
#else
 ...
 */
#if defined(__rtems__)
static inline void *dev_get_parent_plat(const struct udevice *dev)
{
 ...
 */
#if defined(__rtems__)
static inline void *dev_get_uclass_plat(const struct udevice *dev)
{
 ...
 */
#if defined(__rtems__)
static inline void *dev_get_priv(const struct udevice *dev)
{
	return dev->priv_;
}
#else
 ...
 */
#if defined(__rtems__)
static inline void *dev_get_parent_priv(const struct udevice *dev)
{
 ...
 */
#if defined(__rtems__)
static inline void *dev_get_uclass_priv(const struct udevice *dev)
{
