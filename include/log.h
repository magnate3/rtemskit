...
enum log_level_t {
	...
	LOGL_WARNING,
	/** @LOGL_NOTICE: Normal but significant condition, printk() */
	LOGL_NOTICE,
 ...
 * @fmt: printk() format string for log record
...
#define log_emerg(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_alert(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_crit(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_err(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_warning(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_notice(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_info(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
#define log_cont(_fmt, ...)	printk(_fmt, ##__VA_ARGS__)
